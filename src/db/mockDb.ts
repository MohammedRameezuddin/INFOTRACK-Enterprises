...
const INITIAL_ORDERS: Order[] = [

  {
    ...
    customerEmail: 'jane@enterprise.com',
    items: [
      {
        productId: 'prod-1',
        productTitle: 'Dell Latitude 7440 Ultralight',
        quantity: 2,
        price: 98500
      },
      {
        productId: 'prod-9',
        productTitle: 'Ubiquiti UniFi Dream Machine Special Edition',
        quantity: 1,
        price: 64000
      }
    ],
    ...
    shippingAddress: 'T-Hub 2.0, Knowledge City, Madhapur, Hyderabad, Telangana - 500081',
    paymentId: 'pay_HYD8719236',
  ...
  },
  {
    ...
    items: [
      {
        productId: 'prod-6',
        productTitle: 'Hikvision 8MP 4K AccuSense Dome Camera',
        quantity: 8,
        price: 7800
      }
    ],
    ...
    shippingAddress: 'Gachibowli Financial District, Nanakramguda, Hyderabad, Telangana - 500032',
    paymentId: 'pay_NAN8819230',
    createdAt: '2026-05-12T09:15:00Z'
  },
  {
    id: 'ord-4122',
    userId: 'user-cust-2',
    customerName: 'K. Ranga Rao',
    customerEmail: 'krrao@andhra-solutions.com',
    items: [
      {
        productId: 'prod-4',
        productTitle: 'Dell PowerEdge R760 Rack Server',
        quantity: 1,
        price: 495000
      }
    ],
    ...
    orderStatus: 'Pending',
    shippingAddress: 'Industrial Development Area, Autonagar, Vijayawada, Andhra Pradesh - 520007',
...
const INITIAL_SERVICE_REQUESTS: ServiceRequest[] = [
  {
    ...
    serviceId: 'serv-1',
    serviceTitle: 'Annual Maintenance Contract (AMC)',
    status: 'Assigned',
    message: 'Requesting AMC proposal for 40 laptops and 2 network printers in our Madhapur office. Need a physical inspection scheduled.',
    preferredDate: '2026-05-28',
    assignedEngineer: 'Vinay Kumar (Senior Network Architect)',
  ...
  },
  {
    ...
    serviceId: 'serv-2',
    serviceTitle: 'CCTV Surveillance Setup & Management',
    status: 'Pending',
    message: 'Need 12 outdoor bullet cameras installed around the warehouse perimeter. Infrastructure is pre-wired, but need camera mounts and config.',
